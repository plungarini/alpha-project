...
import { WorkoutWeek, WorkoutWeekDay } from 'src/app/shared/models/workout-week.model';
...
@Component({
  templateUrl: './workout-lorenz.component.html',
  styles: [],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class WorkoutLorenzComponent implements OnInit, OnDestroy {
  ...
  initWeeks(uid: string): void {
    this.userWorkoutService.getAll(uid, 'pro')
      .pipe(takeUntil(this.destroyed$))
      .subscribe(weeks => {
